...
이 프로젝트는 Vercel을 통해 배포되어 있습니다. 로컬 설치 없이 바로 사용하실 수 있습니다.

**라이브 데모**: [https://tumae-fe.vercel.app/](https://tumae-fe.vercel.app/)

> 💡 **바로 시작하기**: 위 링크를 클릭하면 바로 튜매 서비스를 이용하실 수 있습니다. 별도의 설치나 설정 없이 웹 브라우저에서 바로 실행됩니다.
...
1. **저장소 클론**
   ```bash
   git clone https://github.com/TumaeProject/tumae-fe.git
   cd tumae-fe
   ```
