        ...
        <div className="flex items-center gap-3">
          {isLoggedIn ? (
            <div className="relative" ref={dropdownRef}>
              ...
              {showDropdown && (
                <div className="absolute right-0 mt-2 w-48 rounded-xl border border-gray-300 bg-white shadow-lg">
                  <Link
                    href="/settings"
                    onClick={() => setShowDropdown(false)}
                    className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 first:rounded-t-xl"
                  >
                    설정
                  </Link>
                  <button
                    onClick={handleLogout}
                    className="w-full px-4 py-3 text-left text-sm text-gray-700 hover:bg-gray-50 last:rounded-b-xl"
                  >
                    로그아웃
                  </button>
                </div>
